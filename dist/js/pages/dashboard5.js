...
var areaChartData2 = {
      labels  : [['Backbone ', 'Equipment', ''], ['Central',' Office', 'Equipment'], ['Power Supply Eq.','and','Temp. Ctrl. Eq.']],
      datasets: [
        {
          label               : 'UP',
...
//-------------
  ...
  options: {
	...
	title: {
		display: true,
		text: 'Statistics Based On Event Alarm Severity Levels'
	}
  }
}
...
//---------------------
    ...
    var stackedBarChartOptions = {
	  ...
	  title: {
		  display: true,
		  text: 'TWAREN Device Survival Status Proportion Chart',
