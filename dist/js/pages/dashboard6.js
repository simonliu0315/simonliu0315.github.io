...
var areaChartData3 = {
      labels  : ['Router', 'Switch', 'OLA', 'ROADM', 'PRM', 'SMR'],
      datasets: [
        {
          label               : 'UP',
          backgroundColor     : 'green',
...
//---------------------
    ...
    var stackedBarChartData2 = $.extend(true, {}, barChartData3)
